...
ggplot(Vd_vis_IV, aes(x = model, y = value)) +
  ...
  labs(
    ...
    y = "Vd, L", 
    title = "Vd, allometric scaling using different allometric scale exponents, IV route of administration",
    subtitle = "Mean human dose = 0.49 g/kg, rat dose = 0.5 g/kg"
  )
...
ggplot(Beta_vis_IV, aes(x = model, y = value)) +
  ...
  labs(
    x = "Used allometric scale exponent",
    y = "Beta", 
    title = "Beta, allometric scaling using different allometric scale exponents, IV route of administration",
    subtitle = "Mean human dose = 0.49 g/kg, rat dose = 0.5 g/kg"
  )
...
ggplot(Vmax_vis_IV, aes(x = model, y = value)) +
  ...
  labs(
    x = "Used allometric scale exponent",
    y = "Vmax", 
    title = "Vmax, allometric scaling using different allometric scale exponents, IV route of administration",
    subtitle = "Mean human dose = 0.49 g/kg, rat dose = 0.5 g/kg"
  )

```

```{r allometric PO dose 750 mg}
...
ggplot(Vd_vis_PO, aes(x = model, y = value)) +
  ...
  labs(
    x = "Used allometric scale exponent",
    y = "Vd, L", 
    title = "Vd, allometric scaling using different allometric scale exponents, PO route of administration",
    subtitle = "Mean human dose = 0.60 g/kg, rat dose = 0.75 g/kg"
  )
```

```{r allometric PO dose 3 g}
...
ggplot(Vd_vis_PO, aes(x = model, y = value)) +
  ...
  labs(
    ...
    y = "Vd, L", 
    title = "Vd, allometric scaling using different allometric scale exponents, PO route of administration",
    subtitle = "Mean human dose = 0.60 g/kg, rat dose = 3.00 g/kg"
  )
```

```{r Beta visual PO dose 3 g}
...
ggplot(Vd_vis_PO, aes(x = model, y = value)) +
  ...
  labs(
    x = "Used allometric scale exponent",
    y = "Beta", 
    title = "Beta, allometric scaling using different allometric scale exponents, PO route of administration",
    subtitle = "Mean human dose = 0.60 g/kg, rat dose = 3.00 g/kg"
  )
```

```{r Vmax visual PO dose 3 g}
...
ggplot(Vd_vis_PO, aes(x = model, y = value)) +
  ...
  labs(
    x = "Used allometric scale exponent",
    y = "Vmax", 
    title = "Vmax, allometric scaling using different allometric scale exponents, PO route of administration",
    subtitle = "Mean human dose = 0.60 g/kg, rat dose = 3.00 g/kg"
  )
```