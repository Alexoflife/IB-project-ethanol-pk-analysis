...
anova(fit_Vd_2, fit_Vd_3)

anova(fit_Vd_2, fit_Vd_4)

anova(fit_Vd_2, fit_Vd_5)
```
...
```{r, fig.width = 16, fig.height = 8}
check_model(fit_Vd_3_add2)
```

## Beta

```{r}
fit_Beta_1 <- lm(log(Beta) ~ dose_g_per_kg + route + food + site, data = order_0_df_factor)

summary(fit_Beta_1)

cat("\n===============================================================\n")

fit_Beta_2 <- lm(log(Beta) ~ dose_g_per_kg * route + food + site, data = order_0_df_factor)

summary(fit_Beta_3)

cat("\n===============================================================\n")

fit_Beta_3 <- lm(log(Beta) ~ dose_g_per_kg * route, data = order_0_df_factor)

summary(fit_Beta_3)

cat("\n===============================================================\n")

fit_Beta_4 <- lm(log(Beta) ~ dose_g_per_kg * route + site, data = order_0_df_factor)

summary(fit_Beta_4)

cat("\n===============================================================\n")

fit_Beta_5 <- lm(log(Beta) ~ dose_g_per_kg * route + food, data = order_0_df_factor)

fit_Beta_5ns <- lm(log(Beta) ~ ns(dose_g_per_kg, 3) * route + food, data = order_0_df_factor)

summary(fit_Beta_5)

summary(fit_Beta_5ns)

anova(fit_Beta_5, fit_Beta_5ns)

cat("\n===============================================================\n")

anova(fit_Beta_1, fit_Beta_2)

anova(fit_Beta_2, fit_Beta_3)

anova(fit_Beta_2, fit_Beta_4)

anova(fit_Beta_2, fit_Beta_5)

anova(fit_Beta_3, fit_Beta_4)

anova(fit_Beta_3, fit_Beta_5)
```

```{r}
fit_Beta_5_sub <- lm(log(Beta) ~ 1,  data = order_0_df_factor)

anova(fit_Beta_5ns, fit_Beta_5_sub)
```

```{r, fig.width = 16, fig.height = 8}
check_model(fit_Beta_5ns)
```

```{r}
fit_Beta_5_add <- lm(log(Beta) ~ ns(dose_g_per_kg, 3) * route + food + wt_kg + sex, data = order_0_df_factor)

fit_Beta_5_add2 <- lm(log(Beta) ~ ns(dose_g_per_kg, 3) * route + food + wt_kg * sex, data = order_0_df_factor)

summary(fit_Beta_5_add)

summary(fit_Beta_5_add2)

anova(fit_Beta_5_add, fit_Beta_5_add2)
```

```{r, fig.width = 16, fig.height = 8}
check_model(fit_Beta_5_add)
```
